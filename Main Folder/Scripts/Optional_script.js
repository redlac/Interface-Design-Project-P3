...
function remove_table(l) 
{
    for (var i = 0; i < l.length; i++) {
        document.getElementById("table_output").deleteRow(l);
    } 
}
...
function searchByName(n) 
{
    ...
    {
        var objN = obj.itemName;
        objN = objN.toLowerCase();
        console.log(objN, str);
        if(objN.startsWith(str)) 
        {
            console("check true")
            ...
            //Rows
            var row = myTable.insertRow(table_length + 1);
